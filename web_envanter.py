...
with col_logo1:
    try:
        st.image("a06ef42d-f0d1-4771-8789-65bb88a97b8b.png", use_column_width=True)
    except FileNotFoundError:
        st.warning("a06ef42d-f0d1-4771-8789-65bb88a97b8b.png bulunamadı")
...
with col_logo2:
    try:
        st.image("94ec0029-c642-4085-aaad-fcb4346f4391.png", use_column_width=True)
    except FileNotFoundError:
        st.warning("94ec0029-c642-4085-aaad-fcb4346f4391.png bulunamadı")
